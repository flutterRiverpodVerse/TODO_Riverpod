...
abstract class $TodoModelCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {String id, String name, String desc, DateTime date, bool isCompleted});
}
...
class _$TodoModelImpl implements _TodoModel {
  ...
  @override
  String toString() {
    return 'TodoModel(id: $id, name: $name, desc: $desc, date: $date, isCompleted: $isCompleted)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, name, desc, date, isCompleted);
